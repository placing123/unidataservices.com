...
public function register_store()
	...
	function send_mail2($customer_id, $password, $pdf, $email)
	{
		...
		$fromemail = "support@unidataservices.com";
		$toemail = $email;
		...
		$this->email->from($fromemail, "Unidataservice");
	...
	public function send_mail($customer_id, $password, $pdf, $email)
	{
		...
		try {
			...
			$mail->Username   = 'support@unidataservices.com';                     //SMTP username
			$mail->Password   = 'pRVNViUg$i*w';
			...
			//Recipients
			$mail->setFrom('support@unidataservices.com', 'Unidataservice');
			$mail->addAddress($email);     //Add a recipient
			$audio_file = '/home/ltx8i4fswi8y/unidataservices.com/admin_assets/audio_demo.mp3';
			$attactfile = '/home/ltx8i4fswi8y/unidataservices.com/admin_assets/pdf/' . $pdf;
...

	{
		...
		$sendfrom = 'legal@unidataservices.com';
		...
		public function send_mail_withmailer($email, $sendfrom, $mesg, $subject)
	{
		...
		try {
			...
			$mail->Username   = 'legal@unidataservices.com';                     //SMTP username
			...
			$mail->setFrom($sendfrom, 'Unidataservice');
			$mail->addAddress($email);     //Add a recipient
			$mail->isHTML(true);                                  //Set email format to HTML
